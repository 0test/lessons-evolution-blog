...
Можно указать её в админ-панели либо вынести в файл `settings.php` (третий урок).
...
```
Двойные слеши нужны для экранирования.
Обратите внимание, что этот namespace у нас будет во всех контроллерах в папке `core/custom/packages/main/src/Controllers/`.
